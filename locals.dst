...
locals {
  ...
  neurochat_acr_name          = replace("acrneurochat${var.environment}", "-", "")
  container_apps_env_name     = "cae-${local.resource_prefix}"
  container_app_backend_name  = "ca-neurochat-backend-${var.environment}"
  container_app_frontend_name = "ca-neurochat-frontend-${var.environment}"
